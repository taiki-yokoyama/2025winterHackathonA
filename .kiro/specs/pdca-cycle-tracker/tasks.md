...
- [x] 5. CAP投稿機能の実装（クライアントサイド）




  - [x] 5.1 JavaScriptによる画面遷移制御
...
- [x] 13. UI/UXの調整
  ...
  - [x] 13.3 Lucideアイコンの統合
    ...
    - Lucideアイコンライブラリをプロジェクトに追加（CDNまたはローカル）
    - ロゴにLucideアイコンを使用
    - ナビゲーション、ボタン、フォーム要素にアイコンを追加
    - 統一されたアイコンスタイルを適用
    - _要件: 10.1, 10.2_
